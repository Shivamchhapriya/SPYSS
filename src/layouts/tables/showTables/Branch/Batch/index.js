...
import batchInBranchTable from "layouts/tables/tablesData/data/branchData/batchTable.js/batchTableData";
import BatchInAreaForm from "layouts/authentication/sign-up/Branch/BatchInBranchForm";
        ...
        <Grid container spacing={6}>
          <Grid item xs={12}>
            <Card>
              ...
              <MDBox pt={3}>
                <Button onClick={hopen}>Add Batch</Button>
