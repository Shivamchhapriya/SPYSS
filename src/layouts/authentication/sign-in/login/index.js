...
export default function Login() {
  ...
  return (
    <Container className="login" style={{overflow:'hidden'}}>
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static" style={{ background: "white", boxShadow: "none"}}>
          <Toolbar>
            ...
            />
            <Typography variant="h6" style={{ position: "relative", left: "55rem", color: "gray" }}>
        ...
        >
          ...
          >
            <div style={{ position: "relative" }}>
              ...
              >
                Welcome <span style={{ color: 'navy', fontWeight: 'bolder' }}> to </span> <span style={{ color: 'navy', fontWeight: 'bolder', display: 'flex' }}> Login </span>
              </Typography>
